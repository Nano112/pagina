...
// runtime instead of sharing the one the import map points at.
import { mountAll, defaultTheme, type ThemeTokens } from "kineglyph";
...
const figures = await mountAll({ theme: () => themes[current()] });
